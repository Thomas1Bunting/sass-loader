 ...
 */
function importsToResolve(url, theme) {
    ...
    if (basename.charAt(0) === "_") {
        return [
            `${ request }.${ theme }.scss`, `${ request }.${ theme }.sass`, `${ request }.${ theme }.css`, `${ request }.scss`, `${ request }.sass`, `${ request }.css`,
            url
        ];
    }
    ...
    return [
        `${ dirname }/_${ basename }.${ theme }.scss`, `${ dirname }/_${ basename }.${ theme }.sass`, `${ dirname }/_${ basename }.${ theme }.css`,
        `${ request }.${ theme }.scss`, `${ request }.${ theme }.sass`, `${ request }.${ theme }.css`,
