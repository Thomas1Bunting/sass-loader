 ...
 */
function sassLoader(content, theme) {
    console.log(content)
    const callback = this.async();
    const isSync = typeof callback !== "function";
    const self = this;
    this.resourcePath = getThemedResourcePath(this.resourcePath, theme);
    const resourcePath = getThemedResourcePath(this.resourcePath, theme);//this.resourcePath;
    ...
    if(this.resourcePath.indexOf('.moneyhero') != -1) {
        //console.log(options)
    }
...
function getThemedResourcePath(resourcePath, theme) {
    const themes = 'moneyhero';
    var themedResourcePath = getThemedPath(resourcePath, themes);
